...
$sql = "UPDATE  services SET image='$filename', largr_image='$filename1', title='$title', short_description='$short_description',  long_description='$long_description' WHERE id=$id";
