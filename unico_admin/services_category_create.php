            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Form: Services Categories</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="services_category_store.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <!-- <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Upload Large imge</strong></label>
                                <div class="col-sm-9">
