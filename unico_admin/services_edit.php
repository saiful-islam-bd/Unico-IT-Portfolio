                ...
                <div class="card">
                    ...
                    <form action="services_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Upload an Large image</strong></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <textarea class="summernote" value="" name="long_description" required><?php echo $long_description ?></textarea>


                                    <!-- <input type="text" class="form-control" placeholder="Our goal text" value="<?php echo $our_goal_text ?>" name="our_goal_text" required> -->
                                </div>
                            </div>
